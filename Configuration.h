...
#define STRING_CONFIG_H_AUTHOR "(abegines, 2018/06/23)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AnycubicDelta+"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 90 // mm [abc: my bed has little sticker, you can write 100 here]
    // Set the steprate for papertest probing
    #define PROBE_MANUALLY_STEP 0.025
  #endif

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 110.0 // mm [abc: my bed has little sticker, you can write 100 here]

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 271.5 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 289.00 // get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 104 }  // default steps per unit for Kossel (GT2, 20 tooth)
